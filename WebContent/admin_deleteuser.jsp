...
<body>
	...
	<div class="mainbackground">
		<div class="mainview">
				...
				<form name="tbform" id="tbform" action="AdminDelUserServlet" method="get">
    ...
    <input type="button" name="go" id="go" value="删除"  onclick="findButton()"/>
    </form>
		</div>
...
var init = function(){
	...
	try {  
		...
		if(conn != null){        
			...
			String sql ="select * from user;";  //实际查询语句
