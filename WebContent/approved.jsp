...
<body>
	...
	<div class="mainbackground">
		<div class="mainview">
				...
				<h3>已审批合同</h3>
				查找已审批合同:<input type="text" id="contractname" name="contractname"
...
try {  
	...
	if(conn != null){        
		...
		String sql ="select * from contract a,contract_process b where a.id=b.id and b.type=3 and b.state = 1 and b.uname = '"+user+"';";  //实际查询语句
