...
<body>
	...
	<div class="mainbackground">
		<div class="mainview">
				<h3>待定稿合同</h3>
				查找待定稿合同:<input type="text" id="contractname" name="contractname"
				...
				<br>
					...
					<form name="tbform" id="tbform" action="AdminConfirmServlet" method="get">
    ...
    <input type="button" name="go" id="go" value="定稿"  onclick="findButton()"/>
    </form>
		</div>
	</div>
	<div class="photo"></div>
