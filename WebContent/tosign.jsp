...
<body>
	...
	<div class="mainbackground">
		<div class="mainview">
				<h3>待签订合同</h3>
				查找待签订合同:<input type="text" id="contractname" name="contractname"
				...
				<form name="tbform" id="tbform" action="TosignServlet" method="get">
    ...
    <input type="button" name="go" id="go" value="签订"  onclick="findButton()"/>
    </form>
		</div>
	</div>
	<div class="photo"></div>
...
try {  
	...
	if(conn != null){        
		...
		String sql ="select * from contract a,contract_process b  where a.id=b.id and a.type=4 and b.type = 4 and b.state = 0 and b.uname = '"+user+"';";  //实际查询语句
