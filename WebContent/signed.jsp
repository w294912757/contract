...
<body>
	...
	<div class="mainbackground">
		<div class="mainview">
				...
				<h3>已签订合同</h3>
				查找已签订合同:<input type="text" id="contractname" name="contractname"
...
try {  
	...
	if(conn != null){        
		...
		String sql ="select * from contract a,contract_process b where a.id=b.id and b.type=4 and b.state = 1 and b.uname = '"+user+"';";  //实际查询语句
