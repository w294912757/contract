...
<body>
    ...
    <input type="button" name="go" id="go" value="审批"  onclick="findButton()"/>
    </form>
		</div>
...
try {  
	...
	if(conn != null){        
		...
		String sql ="select * from contract a where a.id=any(select b.id from contract_state b where b.type='3');";  //实际查询语句
