 ...
 */
@WebServlet("/Admininsertcontract")
public class Admininsertcontract extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public Admininsertcontract() {
		super();
...
//			request.getRequestDispatcher("draft.jsp").forward(request, response);
			...
			try {
				...
				if (contractList.size() == 0) {
					String insert = "insert into contract(id,name,uname,customer,content,beginTime,endTime) values(" + 1
							+ "," + "'" + contractname + "'" + "," + "'" + "admin" + "'" + "," + "'" + client + "'"
							+ "," + "'" + draftcontent + "'" + "," + "'" + begintime + "'" + "," + "'" + endtime
							+ "');";
					...
					String insert = "insert into contract(id,name,uname,customer,content,beginTime,endTime) values("
							+ id + "," + "'" + contractname + "'" + "," + "'" + "admin" + "'" + "," + "'" + client + "'"
							+ "," + "'" + draftcontent + "'" + "," + "'" + begintime + "'" + "," + "'" + endtime
							+ "');";
